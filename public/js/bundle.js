...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYXZlc2VscyIsImEiOiJja3h5bnVrNjI1MndkMnB1YmR3d21kenRrIn0.rEUqeq1wBKOKYmdinW5EuA';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>\u0414\u0435\u043D\u044C ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map);
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Вы успешно вошли на сайт!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Не удалось выйти. Попробуйте ещё раз.');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'Пароль' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type, " \u0431\u044B\u043B \u0443\u0441\u043F\u0435\u0448\u043D\u043E \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D!"));
            }
...
var stripe = Stripe("pk_test_51KFehlCKdjXyoXhqbwPRBVQD3ZdQXyIJMKN4v6n4RiWcFxP8B7QAV0zXESME5wwsoBt9mntPgL6D1r5q6TLEydon00vqhrqvl3");
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector('.btn--save-password').innerHTML = 'Обновление...';
            ...
            case 7:
              document.querySelector('.btn--save-password').innerHTML = 'Пароль сохранён';
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'В обработке...';
